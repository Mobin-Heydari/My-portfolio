  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 p-5 md:p-16 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] md:w-[60vw] border-green-900"
            key={item.name}
            style={{
                //   add these two
